 ...
 * Source Class: Fragment <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */

public interface Fragment extends WrappedIndividual {

    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Fragment_Type
     */
     
    /**
     * Gets all property values for the has_Fragment_Type property.<p>
     * 
     * @returns a collection of values for the has_Fragment_Type property.
     */
    Collection<? extends Fragment_Type> getHas_Fragment_Type();

    /**
     * Checks if the class has a has_Fragment_Type property value.<p>
     * 
     * @return true if there is a has_Fragment_Type property value.
     */
    boolean hasHas_Fragment_Type();

    /**
     * Adds a has_Fragment_Type property value.<p>
     * 
     * @param newHas_Fragment_Type the has_Fragment_Type property value to be added
     */
    void addHas_Fragment_Type(Fragment_Type newHas_Fragment_Type);

    /**
     * Removes a has_Fragment_Type property value.<p>
     * 
     * @param oldHas_Fragment_Type the has_Fragment_Type property value to be removed.
     */
    void removeHas_Fragment_Type(Fragment_Type oldHas_Fragment_Type);
