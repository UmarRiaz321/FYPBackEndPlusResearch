 ...
 * Source Class: Building_Phase <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */

public interface Building_Phase extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Building_Phase_Number
     */
     
    /**
     * Gets all property values for the has_Building_Phase_Number property.<p>
     * 
     * @returns a collection of values for the has_Building_Phase_Number property.
     */
    Collection<? extends String> getHas_Building_Phase_Number();

    /**
     * Checks if the class has a has_Building_Phase_Number property value.<p>
     * 
     * @return true if there is a has_Building_Phase_Number property value.
     */
    boolean hasHas_Building_Phase_Number();

    /**
     * Adds a has_Building_Phase_Number property value.<p>
     * 
     * @param newHas_Building_Phase_Number the has_Building_Phase_Number property value to be added
     */
    void addHas_Building_Phase_Number(String newHas_Building_Phase_Number);

    /**
     * Removes a has_Building_Phase_Number property value.<p>
     * 
     * @param oldHas_Building_Phase_Number the has_Building_Phase_Number property value to be removed.
     */
    void removeHas_Building_Phase_Number(String oldHas_Building_Phase_Number);
