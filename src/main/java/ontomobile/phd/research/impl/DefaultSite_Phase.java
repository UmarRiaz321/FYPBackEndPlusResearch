 ...
 * Source Class: DefaultSite_Phase <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */
public class DefaultSite_Phase extends WrappedIndividualImpl implements Site_Phase {

    public DefaultSite_Phase(CodeGenerationInference ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends String> getHas_Site_Phase_Number() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_SITE_PHASE_NUMBER, String.class);
    }

    public boolean hasHas_Site_Phase_Number() {
		return !getHas_Site_Phase_Number().isEmpty();
    }

    public void addHas_Site_Phase_Number(String newHas_Site_Phase_Number) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_SITE_PHASE_NUMBER, newHas_Site_Phase_Number);
    }

    public void removeHas_Site_Phase_Number(String oldHas_Site_Phase_Number) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_SITE_PHASE_NUMBER, oldHas_Site_Phase_Number);
    }
