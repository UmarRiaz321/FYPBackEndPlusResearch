 ...
 * Source Class: DefaultArchaeological_Context <br>
 * @version generated on Tue Nov 26 14:33:00 GMT+00:00 2019 by umarriaz
 */
public class DefaultArchaeological_Context extends WrappedIndividualImpl implements Archaeological_Context {

    public DefaultArchaeological_Context(CodeGenerationInference ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends Artefact> getContext_contains() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_CONTEXT_CONTAINS,
                                               DefaultArtefact.class);
    }

    public boolean hasContext_contains() {
	   return !getContext_contains().isEmpty();
    }

    public void addContext_contains(Artefact newContext_contains) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_CONTEXT_CONTAINS,
                                       newContext_contains);
    }

    public void removeContext_contains(Artefact oldContext_contains) {
    ...
    public Collection<? extends String> getHas_Context_Number() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_CONTEXT_NUMBER, String.class);
    }

    public boolean hasHas_Context_Number() {
		return !getHas_Context_Number().isEmpty();
    }

    public void addHas_Context_Number(String newHas_Context_Number) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_CONTEXT_NUMBER, newHas_Context_Number);
    }

    public void removeHas_Context_Number(String oldHas_Context_Number) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_CONTEXT_NUMBER, oldHas_Context_Number);
    }
    ...
    public Collection<? extends String> getType_of_Archaeological_Context() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_TYPE_OF_ARCHAEOLOGICAL_CONTEXT, String.class);
    }

    public boolean hasType_of_Archaeological_Context() {
		return !getType_of_Archaeological_Context().isEmpty();
    }

    public void addType_of_Archaeological_Context(String newType_of_Archaeological_Context) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_TYPE_OF_ARCHAEOLOGICAL_CONTEXT, newType_of_Archaeological_Context);
    }

    public void removeType_of_Archaeological_Context(String oldType_of_Archaeological_Context) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_TYPE_OF_ARCHAEOLOGICAL_CONTEXT, oldType_of_Archaeological_Context);
    }
