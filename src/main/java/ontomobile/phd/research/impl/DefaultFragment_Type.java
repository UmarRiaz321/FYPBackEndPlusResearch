 ...
 * Source Class: DefaultFragment_Type <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */
public class DefaultFragment_Type extends WrappedIndividualImpl implements Fragment_Type {

    public DefaultFragment_Type(CodeGenerationInference ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends Integer> getNumber_of_fragments() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_NUMBER_OF_FRAGMENTS, Integer.class);
    }

    public boolean hasNumber_of_fragments() {
		return !getNumber_of_fragments().isEmpty();
    }

    public void addNumber_of_fragments(Integer newNumber_of_fragments) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_NUMBER_OF_FRAGMENTS, newNumber_of_fragments);
    }

    public void removeNumber_of_fragments(Integer oldNumber_of_fragments) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_NUMBER_OF_FRAGMENTS, oldNumber_of_fragments);
    }
    ...
    public Collection<? extends String> getType_of_fragments() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_TYPE_OF_FRAGMENTS, String.class);
    }

    public boolean hasType_of_fragments() {
		return !getType_of_fragments().isEmpty();
    }

    public void addType_of_fragments(String newType_of_fragments) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_TYPE_OF_FRAGMENTS, newType_of_fragments);
    }

    public void removeType_of_fragments(String oldType_of_fragments) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_TYPE_OF_FRAGMENTS, oldType_of_fragments);
    }
