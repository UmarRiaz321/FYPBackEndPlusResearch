 ...
 * Source Class: DefaultFragment <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */
public class DefaultFragment extends WrappedIndividualImpl implements Fragment {

    public DefaultFragment(CodeGenerationInference ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends Fragment_Type> getHas_Fragment_Type() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_HAS_FRAGMENT_TYPE,
                                               DefaultFragment_Type.class);
    }

    public boolean hasHas_Fragment_Type() {
	   return !getHas_Fragment_Type().isEmpty();
    }

    public void addHas_Fragment_Type(Fragment_Type newHas_Fragment_Type) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_HAS_FRAGMENT_TYPE,
                                       newHas_Fragment_Type);
    }

    public void removeHas_Fragment_Type(Fragment_Type oldHas_Fragment_Type) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_HAS_FRAGMENT_TYPE,
                                          oldHas_Fragment_Type);
    }
