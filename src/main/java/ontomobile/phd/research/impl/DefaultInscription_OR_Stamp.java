 ...
 * Source Class: DefaultInscription_OR_Stamp <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */
public class DefaultInscription_OR_Stamp extends WrappedIndividualImpl implements Inscription_OR_Stamp {

    public DefaultInscription_OR_Stamp(CodeGenerationInference ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends Artefact> getIs_inscribed_on() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_IS_INSCRIBED_ON,
                                               DefaultArtefact.class);
    }

    public boolean hasIs_inscribed_on() {
	   return !getIs_inscribed_on().isEmpty();
    }

    public void addIs_inscribed_on(Artefact newIs_inscribed_on) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_IS_INSCRIBED_ON,
                                       newIs_inscribed_on);
    }

    public void removeIs_inscribed_on(Artefact oldIs_inscribed_on) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_IS_INSCRIBED_ON,
                                          oldIs_inscribed_on);
    }
