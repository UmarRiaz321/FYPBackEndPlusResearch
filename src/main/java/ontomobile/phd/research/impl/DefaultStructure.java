...
import ontomobile.phd.research.Structure;
import ontomobile.phd.research.Vocabulary;


/**
 * Generated by Protege (http://protege.stanford.edu).<br>
 * Source Class: DefaultStructure <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */
public class DefaultStructure extends WrappedIndividualImpl implements Structure {

    public DefaultStructure(CodeGenerationInference ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends Artefact> getStructure_contains() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_STRUCTURE_CONTAINS,
                                               DefaultArtefact.class);
    }

    public boolean hasStructure_contains() {
	   return !getStructure_contains().isEmpty();
    }

    public void addStructure_contains(Artefact newStructure_contains) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_STRUCTURE_CONTAINS,
                                       newStructure_contains);
    }

    public void removeStructure_contains(Artefact oldStructure_contains) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_STRUCTURE_CONTAINS,
                                          oldStructure_contains);
    }
