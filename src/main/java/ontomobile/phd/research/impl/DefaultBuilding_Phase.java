 ...
 * Source Class: DefaultBuilding_Phase <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */
public class DefaultBuilding_Phase extends WrappedIndividualImpl implements Building_Phase {

    public DefaultBuilding_Phase(CodeGenerationInference ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends String> getHas_Building_Phase_Number() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_BUILDING_PHASE_NUMBER, String.class);
    }

    public boolean hasHas_Building_Phase_Number() {
		return !getHas_Building_Phase_Number().isEmpty();
    }

    public void addHas_Building_Phase_Number(String newHas_Building_Phase_Number) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_BUILDING_PHASE_NUMBER, newHas_Building_Phase_Number);
    }

    public void removeHas_Building_Phase_Number(String oldHas_Building_Phase_Number) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_BUILDING_PHASE_NUMBER, oldHas_Building_Phase_Number);
    }
