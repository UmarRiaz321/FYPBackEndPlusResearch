 ...
 * Source Class: DefaultDate_Range <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */
public class DefaultDate_Range extends WrappedIndividualImpl implements Date_Range {

    public DefaultDate_Range(CodeGenerationInference ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends String> getHas_End_Date() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_END_DATE, String.class);
    }

    public boolean hasHas_End_Date() {
		return !getHas_End_Date().isEmpty();
    }

    public void addHas_End_Date(String newHas_End_Date) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_END_DATE, newHas_End_Date);
    }

    public void removeHas_End_Date(String oldHas_End_Date) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_END_DATE, oldHas_End_Date);
    }
    ...
    public Collection<? extends String> getHas_Start_Date() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_START_DATE, String.class);
    }

    public boolean hasHas_Start_Date() {
		return !getHas_Start_Date().isEmpty();
    }

    public void addHas_Start_Date(String newHas_Start_Date) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_START_DATE, newHas_Start_Date);
    }

    public void removeHas_Start_Date(String oldHas_Start_Date) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_START_DATE, oldHas_Start_Date);
    }
    ...
    public Collection<? extends String> getSource_for_Date_Range() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SOURCE_FOR_DATE_RANGE, String.class);
    }

    public boolean hasSource_for_Date_Range() {
		return !getSource_for_Date_Range().isEmpty();
    }

    public void addSource_for_Date_Range(String newSource_for_Date_Range) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SOURCE_FOR_DATE_RANGE, newSource_for_Date_Range);
    }

    public void removeSource_for_Date_Range(String oldSource_for_Date_Range) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_SOURCE_FOR_DATE_RANGE, oldSource_for_Date_Range);
    }
