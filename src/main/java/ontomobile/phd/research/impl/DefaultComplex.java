...
import ontomobile.phd.research.Complex;
 ...
 * Source Class: DefaultComplex <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */
public class DefaultComplex extends WrappedIndividualImpl implements Complex {

    public DefaultComplex(CodeGenerationInference ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends String> getHas_Complex_Number() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_COMPLEX_NUMBER, String.class);
    }

    public boolean hasHas_Complex_Number() {
		return !getHas_Complex_Number().isEmpty();
    }

    public void addHas_Complex_Number(String newHas_Complex_Number) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_COMPLEX_NUMBER, newHas_Complex_Number);
    }

    public void removeHas_Complex_Number(String oldHas_Complex_Number) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HAS_COMPLEX_NUMBER, oldHas_Complex_Number);
    }
