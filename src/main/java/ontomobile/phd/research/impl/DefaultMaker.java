 ...
 * Source Class: DefaultMaker <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */
public class DefaultMaker extends WrappedIndividualImpl implements Maker {

    public DefaultMaker(CodeGenerationInference ontology, IRI iri) {
        super(ontology, iri);
    }
    ...
    public Collection<? extends Artefact> getMade() {
        return getDelegate().getPropertyValues(getOwlIndividual(),
                                               Vocabulary.OBJECT_PROPERTY_MADE,
                                               DefaultArtefact.class);
    }

    public boolean hasMade() {
	   return !getMade().isEmpty();
    }

    public void addMade(Artefact newMade) {
        getDelegate().addPropertyValue(getOwlIndividual(),
                                       Vocabulary.OBJECT_PROPERTY_MADE,
                                       newMade);
    }

    public void removeMade(Artefact oldMade) {
        getDelegate().removePropertyValue(getOwlIndividual(),
                                          Vocabulary.OBJECT_PROPERTY_MADE,
                                          oldMade);
    }
