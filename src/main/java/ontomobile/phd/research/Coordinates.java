 ...
 * Source Class: Coordinates <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */

public interface Coordinates extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Elevation_lower_limit
     */
     
    /**
     * Gets all property values for the has_Elevation_lower_limit property.<p>
     * 
     * @returns a collection of values for the has_Elevation_lower_limit property.
     */
    Collection<? extends Float> getHas_Elevation_lower_limit();

    /**
     * Checks if the class has a has_Elevation_lower_limit property value.<p>
     * 
     * @return true if there is a has_Elevation_lower_limit property value.
     */
    boolean hasHas_Elevation_lower_limit();

    /**
     * Adds a has_Elevation_lower_limit property value.<p>
     * 
     * @param newHas_Elevation_lower_limit the has_Elevation_lower_limit property value to be added
     */
    void addHas_Elevation_lower_limit(Float newHas_Elevation_lower_limit);

    /**
     * Removes a has_Elevation_lower_limit property value.<p>
     * 
     * @param oldHas_Elevation_lower_limit the has_Elevation_lower_limit property value to be removed.
     */
    void removeHas_Elevation_lower_limit(Float oldHas_Elevation_lower_limit);



    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Elevation_upper_limit
     */
     
    /**
     * Gets all property values for the has_Elevation_upper_limit property.<p>
     * 
     * @returns a collection of values for the has_Elevation_upper_limit property.
     */
    Collection<? extends Float> getHas_Elevation_upper_limit();

    /**
     * Checks if the class has a has_Elevation_upper_limit property value.<p>
     * 
     * @return true if there is a has_Elevation_upper_limit property value.
     */
    boolean hasHas_Elevation_upper_limit();

    /**
     * Adds a has_Elevation_upper_limit property value.<p>
     * 
     * @param newHas_Elevation_upper_limit the has_Elevation_upper_limit property value to be added
     */
    void addHas_Elevation_upper_limit(Float newHas_Elevation_upper_limit);

    /**
     * Removes a has_Elevation_upper_limit property value.<p>
     * 
     * @param oldHas_Elevation_upper_limit the has_Elevation_upper_limit property value to be removed.
     */
    void removeHas_Elevation_upper_limit(Float oldHas_Elevation_upper_limit);



    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Lower_X_Coordinate
     */
     
    /**
     * Gets all property values for the has_Lower_X_Coordinate property.<p>
     * 
     * @returns a collection of values for the has_Lower_X_Coordinate property.
     */
    Collection<? extends Float> getHas_Lower_X_Coordinate();

    /**
     * Checks if the class has a has_Lower_X_Coordinate property value.<p>
     * 
     * @return true if there is a has_Lower_X_Coordinate property value.
     */
    boolean hasHas_Lower_X_Coordinate();

    /**
     * Adds a has_Lower_X_Coordinate property value.<p>
     * 
     * @param newHas_Lower_X_Coordinate the has_Lower_X_Coordinate property value to be added
     */
    void addHas_Lower_X_Coordinate(Float newHas_Lower_X_Coordinate);

    /**
     * Removes a has_Lower_X_Coordinate property value.<p>
     * 
     * @param oldHas_Lower_X_Coordinate the has_Lower_X_Coordinate property value to be removed.
     */
    void removeHas_Lower_X_Coordinate(Float oldHas_Lower_X_Coordinate);



    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Lower_Y_Coordinate
     */
     
    /**
     * Gets all property values for the has_Lower_Y_Coordinate property.<p>
     * 
     * @returns a collection of values for the has_Lower_Y_Coordinate property.
     */
    Collection<? extends Float> getHas_Lower_Y_Coordinate();

    /**
     * Checks if the class has a has_Lower_Y_Coordinate property value.<p>
     * 
     * @return true if there is a has_Lower_Y_Coordinate property value.
     */
    boolean hasHas_Lower_Y_Coordinate();

    /**
     * Adds a has_Lower_Y_Coordinate property value.<p>
     * 
     * @param newHas_Lower_Y_Coordinate the has_Lower_Y_Coordinate property value to be added
     */
    void addHas_Lower_Y_Coordinate(Float newHas_Lower_Y_Coordinate);

    /**
     * Removes a has_Lower_Y_Coordinate property value.<p>
     * 
     * @param oldHas_Lower_Y_Coordinate the has_Lower_Y_Coordinate property value to be removed.
     */
    void removeHas_Lower_Y_Coordinate(Float oldHas_Lower_Y_Coordinate);
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Upper_X_Coordinate
     */
     
    /**
     * Gets all property values for the has_Upper_X_Coordinate property.<p>
     * 
     * @returns a collection of values for the has_Upper_X_Coordinate property.
     */
    Collection<? extends Float> getHas_Upper_X_Coordinate();

    /**
     * Checks if the class has a has_Upper_X_Coordinate property value.<p>
     * 
     * @return true if there is a has_Upper_X_Coordinate property value.
     */
    boolean hasHas_Upper_X_Coordinate();

    /**
     * Adds a has_Upper_X_Coordinate property value.<p>
     * 
     * @param newHas_Upper_X_Coordinate the has_Upper_X_Coordinate property value to be added
     */
    void addHas_Upper_X_Coordinate(Float newHas_Upper_X_Coordinate);

    /**
     * Removes a has_Upper_X_Coordinate property value.<p>
     * 
     * @param oldHas_Upper_X_Coordinate the has_Upper_X_Coordinate property value to be removed.
     */
    void removeHas_Upper_X_Coordinate(Float oldHas_Upper_X_Coordinate);



    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Upper_Y_Coordinate
     */
     
    /**
     * Gets all property values for the has_Upper_Y_Coordinate property.<p>
     * 
     * @returns a collection of values for the has_Upper_Y_Coordinate property.
     */
    Collection<? extends Float> getHas_Upper_Y_Coordinate();

    /**
     * Checks if the class has a has_Upper_Y_Coordinate property value.<p>
     * 
     * @return true if there is a has_Upper_Y_Coordinate property value.
     */
    boolean hasHas_Upper_Y_Coordinate();

    /**
     * Adds a has_Upper_Y_Coordinate property value.<p>
     * 
     * @param newHas_Upper_Y_Coordinate the has_Upper_Y_Coordinate property value to be added
     */
    void addHas_Upper_Y_Coordinate(Float newHas_Upper_Y_Coordinate);

    /**
     * Removes a has_Upper_Y_Coordinate property value.<p>
     * 
     * @param oldHas_Upper_Y_Coordinate the has_Upper_Y_Coordinate property value to be removed.
     */
    void removeHas_Upper_Y_Coordinate(Float oldHas_Upper_Y_Coordinate);
