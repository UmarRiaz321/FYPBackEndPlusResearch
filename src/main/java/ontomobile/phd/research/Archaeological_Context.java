 ...
 * Source Class: Archaeological_Context <br>
 * @version generated on Tue Nov 26 14:33:00 GMT+00:00 2019 by umarriaz
 */

public interface Archaeological_Context extends WrappedIndividual {

    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#Context_contains
     */
     
    /**
     * Gets all property values for the Context_contains property.<p>
     * 
     * @returns a collection of values for the Context_contains property.
     */
    Collection<? extends Artefact> getContext_contains();

    /**
     * Checks if the class has a Context_contains property value.<p>
     * 
     * @return true if there is a Context_contains property value.
     */
    boolean hasContext_contains();

    /**
     * Adds a Context_contains property value.<p>
     * 
     * @param newContext_contains the Context_contains property value to be added
     */
    void addContext_contains(Artefact newContext_contains);

    /**
     * Removes a Context_contains property value.<p>
     * 
     * @param oldContext_contains the Context_contains property value to be removed.
     */
    void removeContext_contains(Artefact oldContext_contains);
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Context_Number
     */
     
    /**
     * Gets all property values for the has_Context_Number property.<p>
     * 
     * @returns a collection of values for the has_Context_Number property.
     */
    Collection<? extends String> getHas_Context_Number();

    /**
     * Checks if the class has a has_Context_Number property value.<p>
     * 
     * @return true if there is a has_Context_Number property value.
     */
    boolean hasHas_Context_Number();

    /**
     * Adds a has_Context_Number property value.<p>
     * 
     * @param newHas_Context_Number the has_Context_Number property value to be added
     */
    void addHas_Context_Number(String newHas_Context_Number);

    /**
     * Removes a has_Context_Number property value.<p>
     * 
     * @param oldHas_Context_Number the has_Context_Number property value to be removed.
     */
    void removeHas_Context_Number(String oldHas_Context_Number);
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#type_of_Archaeological_Context
     */
     
    /**
     * Gets all property values for the type_of_Archaeological_Context property.<p>
     * 
     * @returns a collection of values for the type_of_Archaeological_Context property.
     */
    Collection<? extends String> getType_of_Archaeological_Context();

    /**
     * Checks if the class has a type_of_Archaeological_Context property value.<p>
     * 
     * @return true if there is a type_of_Archaeological_Context property value.
     */
    boolean hasType_of_Archaeological_Context();

    /**
     * Adds a type_of_Archaeological_Context property value.<p>
     * 
     * @param newType_of_Archaeological_Context the type_of_Archaeological_Context property value to be added
     */
    void addType_of_Archaeological_Context(String newType_of_Archaeological_Context);

    /**
     * Removes a type_of_Archaeological_Context property value.<p>
     * 
     * @param oldType_of_Archaeological_Context the type_of_Archaeological_Context property value to be removed.
     */
    void removeType_of_Archaeological_Context(String oldType_of_Archaeological_Context);
