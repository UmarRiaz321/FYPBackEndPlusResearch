 ...
 * Source Class: Complex <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */

public interface Complex extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Complex_Number
     */
     
    /**
     * Gets all property values for the has_Complex_Number property.<p>
     * 
     * @returns a collection of values for the has_Complex_Number property.
     */
    Collection<? extends String> getHas_Complex_Number();

    /**
     * Checks if the class has a has_Complex_Number property value.<p>
     * 
     * @return true if there is a has_Complex_Number property value.
     */
    boolean hasHas_Complex_Number();

    /**
     * Adds a has_Complex_Number property value.<p>
     * 
     * @param newHas_Complex_Number the has_Complex_Number property value to be added
     */
    void addHas_Complex_Number(String newHas_Complex_Number);

    /**
     * Removes a has_Complex_Number property value.<p>
     * 
     * @param oldHas_Complex_Number the has_Complex_Number property value to be removed.
     */
    void removeHas_Complex_Number(String oldHas_Complex_Number);
