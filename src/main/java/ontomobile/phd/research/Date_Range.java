 ...
 * Source Class: Date_Range <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */

public interface Date_Range extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_End_Date
     */
     
    /**
     * Gets all property values for the has_End_Date property.<p>
     * 
     * @returns a collection of values for the has_End_Date property.
     */
    Collection<? extends String> getHas_End_Date();

    /**
     * Checks if the class has a has_End_Date property value.<p>
     * 
     * @return true if there is a has_End_Date property value.
     */
    boolean hasHas_End_Date();

    /**
     * Adds a has_End_Date property value.<p>
     * 
     * @param newHas_End_Date the has_End_Date property value to be added
     */
    void addHas_End_Date(String newHas_End_Date);

    /**
     * Removes a has_End_Date property value.<p>
     * 
     * @param oldHas_End_Date the has_End_Date property value to be removed.
     */
    void removeHas_End_Date(String oldHas_End_Date);
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#has_Start_Date
     */
     
    /**
     * Gets all property values for the has_Start_Date property.<p>
     * 
     * @returns a collection of values for the has_Start_Date property.
     */
    Collection<? extends String> getHas_Start_Date();

    /**
     * Checks if the class has a has_Start_Date property value.<p>
     * 
     * @return true if there is a has_Start_Date property value.
     */
    boolean hasHas_Start_Date();

    /**
     * Adds a has_Start_Date property value.<p>
     * 
     * @param newHas_Start_Date the has_Start_Date property value to be added
     */
    void addHas_Start_Date(String newHas_Start_Date);

    /**
     * Removes a has_Start_Date property value.<p>
     * 
     * @param oldHas_Start_Date the has_Start_Date property value to be removed.
     */
    void removeHas_Start_Date(String oldHas_Start_Date);



    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#source_for_Date_Range
     */
     
    /**
     * Gets all property values for the source_for_Date_Range property.<p>
     * 
     * @returns a collection of values for the source_for_Date_Range property.
     */
    Collection<? extends String> getSource_for_Date_Range();

    /**
     * Checks if the class has a source_for_Date_Range property value.<p>
     * 
     * @return true if there is a source_for_Date_Range property value.
     */
    boolean hasSource_for_Date_Range();

    /**
     * Adds a source_for_Date_Range property value.<p>
     * 
     * @param newSource_for_Date_Range the source_for_Date_Range property value to be added
     */
    void addSource_for_Date_Range(String newSource_for_Date_Range);

    /**
     * Removes a source_for_Date_Range property value.<p>
     * 
     * @param oldSource_for_Date_Range the source_for_Date_Range property value to be removed.
     */
    void removeSource_for_Date_Range(String oldSource_for_Date_Range);
