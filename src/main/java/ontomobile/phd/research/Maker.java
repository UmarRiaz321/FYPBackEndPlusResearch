 ...
 * Source Class: Maker <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */

public interface Maker extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#made
     */
     
    /**
     * Gets all property values for the made property.<p>
     * 
     * @returns a collection of values for the made property.
     */
    Collection<? extends Artefact> getMade();

    /**
     * Checks if the class has a made property value.<p>
     * 
     * @return true if there is a made property value.
     */
    boolean hasMade();

    /**
     * Adds a made property value.<p>
     * 
     * @param newMade the made property value to be added
     */
    void addMade(Artefact newMade);

    /**
     * Removes a made property value.<p>
     * 
     * @param oldMade the made property value to be removed.
     */
    void removeMade(Artefact oldMade);
