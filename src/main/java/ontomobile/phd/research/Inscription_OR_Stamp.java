 ...
 * Source Class: Inscription_OR_Stamp <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */

public interface Inscription_OR_Stamp extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#is_inscribed_on
     */
     
    /**
     * Gets all property values for the is_inscribed_on property.<p>
     * 
     * @returns a collection of values for the is_inscribed_on property.
     */
    Collection<? extends Artefact> getIs_inscribed_on();

    /**
     * Checks if the class has a is_inscribed_on property value.<p>
     * 
     * @return true if there is a is_inscribed_on property value.
     */
    boolean hasIs_inscribed_on();

    /**
     * Adds a is_inscribed_on property value.<p>
     * 
     * @param newIs_inscribed_on the is_inscribed_on property value to be added
     */
    void addIs_inscribed_on(Artefact newIs_inscribed_on);

    /**
     * Removes a is_inscribed_on property value.<p>
     * 
     * @param oldIs_inscribed_on the is_inscribed_on property value to be removed.
     */
    void removeIs_inscribed_on(Artefact oldIs_inscribed_on);
