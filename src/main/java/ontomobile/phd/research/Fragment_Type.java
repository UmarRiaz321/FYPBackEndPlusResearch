 ...
 * Source Class: Fragment_Type <br>
 * @version generated on Tue Nov 26 14:33:01 GMT+00:00 2019 by umarriaz
 */

public interface Fragment_Type extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#number_of_fragments
     */
     
    /**
     * Gets all property values for the number_of_fragments property.<p>
     * 
     * @returns a collection of values for the number_of_fragments property.
     */
    Collection<? extends Integer> getNumber_of_fragments();

    /**
     * Checks if the class has a number_of_fragments property value.<p>
     * 
     * @return true if there is a number_of_fragments property value.
     */
    boolean hasNumber_of_fragments();

    /**
     * Adds a number_of_fragments property value.<p>
     * 
     * @param newNumber_of_fragments the number_of_fragments property value to be added
     */
    void addNumber_of_fragments(Integer newNumber_of_fragments);

    /**
     * Removes a number_of_fragments property value.<p>
     * 
     * @param oldNumber_of_fragments the number_of_fragments property value to be removed.
     */
    void removeNumber_of_fragments(Integer oldNumber_of_fragments);



    /* ***************************************************
     * Property http://www.semanticweb.org/daan/ontologies/2016/3/BDRTontology#type_of_fragments
     */
     
    /**
     * Gets all property values for the type_of_fragments property.<p>
     * 
     * @returns a collection of values for the type_of_fragments property.
     */
    Collection<? extends String> getType_of_fragments();

    /**
     * Checks if the class has a type_of_fragments property value.<p>
     * 
     * @return true if there is a type_of_fragments property value.
     */
    boolean hasType_of_fragments();

    /**
     * Adds a type_of_fragments property value.<p>
     * 
     * @param newType_of_fragments the type_of_fragments property value to be added
     */
    void addType_of_fragments(String newType_of_fragments);

    /**
     * Removes a type_of_fragments property value.<p>
     * 
     * @param oldType_of_fragments the type_of_fragments property value to be removed.
     */
    void removeType_of_fragments(String oldType_of_fragments);
